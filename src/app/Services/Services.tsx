            ...
            <AnimatePresence>
                {sign == -1 && (
                    <motion.div
                        ...
                        <Button disabled={signOutVal == 2} onClick={() => { setSignOutVal(2); signOut({ redirect: false }); setSign(-2) }} className="cursor-pointer bg-red-500 hover:bg-red-600">{signOutVal === 2 ? 'Chargement, veuillez patienter...' : 'Se déconnecter'}</Button>
                    </motion.div >
                )}
            </AnimatePresence>
